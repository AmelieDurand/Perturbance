...
@ck.command()
@ck.option(
    "--data-root", "-dr", default="data/", help="Data root folder", required=True
)
...
@ck.option(
    ...
    help="Experimental annotations",
)
@ck.option(
    "--chunk-size", "-cs", default=1000, help="Number of sequences to read at a time"
)
